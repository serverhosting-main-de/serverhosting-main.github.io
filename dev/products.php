...
<head>
    ...
    <style>
        ...
        .mt-5 {
            margin-top: 3rem;
            /* Anpassung der Margin-Top-Eigenschaft */
        }
    </style>
</head>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <p class="card-text">Cores:
                                    <?php echo $row['cores']; ?>
                                </p>
                                <p class="card-text">IPs:
                                    <?php echo $row['ips']; ?>
                                </p>
                                <p class="card-text">Preis: $
                                    <?php echo $row['price']; ?>
                                </p>
                                <a href="add_to_cart.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">In den
                                    Warenkorb</a>
                            </div>
                        </div>
                    </div>
